...
Der Kanal `alarme-v2` wird beim Start mit höchster Wichtigkeit angelegt, umgeht
«Nicht stören» und spielt den Ton über den Alarm-Audiokanal (`AudioAttributes`
`usage: ALARM`) – wie ein Wecker klingt er damit auch bei Lautlos- und
Vibrationsmodus. Dafür braucht es keine Bewilligung, nur die normale
Notification-Berechtigung. Details und der Alleinarbeits-Countdown
(Notifee-Chronometer) stehen in [`mobile/README.md`](README.md#android).
