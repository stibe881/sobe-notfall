...
<nav class="inhalt" aria-label="Inhalt">
  ...
  <ol>
    ...
    <li><a href="#a7"><span class="zahl">7</span> Organisation und Einstellungen</a></li>
...
<section id="a7">
  <h2 class="abschnitt"><span class="zahl">7</span> Organisation und Einstellungen</h2>
  <p>
    Unter <span class="ui">Einstellungen &amp; Konfiguration</span> binden Sie die Dienste des Kunden an.
  ...
  <figure class="bild-breit">
    <img src="bilder/web-26-organisation-redundanz.webp" alt="Seite Einstellungen &amp; Konfiguration mit den Karten Organisation und Auftritt sowie Redundanz">
...
<section id="a8">
  ...
  <p>
    ...
    unter <span class="ui">Einstellungen &amp; Konfiguration &rarr; App-Verbindung</span> einen QR-Code.
  </p>
  <figure class="bild-breit">
...
<section id="a9">
  ...
  <h3>Einrichten</h3>
  <ol>
    <li>Im Portal unter <span class="ui">Einstellungen &amp; Konfiguration &rsaquo; LoRaWAN-Netz / Alarmknöpfe</span>
  ...
  <div class="hinweis hinweis--warnung">
    ...
    <p>
      Bietet der Netzserver beim Anlegen eines Geräts einen Knopf wie
      <span class="ui">Autogenerate</span> für den Application Key: <b>nicht drücken.</b>
      Jedes Gerät bringt seinen Schlüssel ab Werk mit &ndash; aufgedruckt oder im
      Beipackzettel. Ein erzeugter Schlüssel ist dem Gerät unbekannt, das Anlernen
      misslingt, und die Fehlersuche führt in die Irre, weil alles andere richtig
      aussieht. Der Knopf ist für Geräte gedacht, die man selbst programmiert.
    </p>
  </div>
  <div class="hinweis">
    <p class="marke-klein">Alle Adressfelder ausfüllen</p>
    <p>
      Verlangt die Oberfläche des Gateways getrennte Adressen für Uplink, Beitritt,
      Quittung und Gerätezustand, tragen Sie überall <b>dieselbe</b> ein. Bleibt
      eines leer, weist das Formular die ganze Anwendung ab &ndash; teils ohne zu
      sagen, welches Feld gemeint ist.
    </p>
    <p>
      Die zusätzlichen Meldungen schaden nicht: Der Alarmserver verbucht sie als
      Lebenszeichen. Ein Alarm kann daraus nicht entstehen, dafür braucht es eine
      echte Funknutzlast. Die Meldung über den Gerätezustand liefert zudem den
      Batteriestand, ohne dass ihn das Gerät selbst mitschicken müsste.
    </p>
  </div>
  <div class="hinweis">
  ...
  <div class="hinweis">
    ...
    <p>
      Unter <span class="ui">Einstellungen &amp; Konfiguration &rsaquo; LoRaWAN-Netz / Alarmknöpfe</span> steht
...
<section id="a10">
  ...
  <ol class="schritte">
    ...
    <li>Auf dem <b>Hauptserver</b> unter <span class="ui">Einstellungen &amp; Konfiguration &rarr; Redundanz</span>: einschalten, Rolle <span class="ui">Hauptserver</span>, Adresse des Partners eintragen, <span class="ui">Speichern</span>. Das erzeugte <b>Geheimnis kopieren</b>.</li>
  ...
  <div class="tabelle-huelle">
    <table>
      ...
      <tbody>
        ...
        <tr><td>4</td><td>Dienste des Kunden unter Einstellungen eingetragen und getestet (Abschnitt 7)</td></tr>
