  ...
  <div class="tabelle-huelle">
    <table>
      ...
      <tbody>
        ...
        <tr><th scope="row">Lagemeldung senden</th><td>nein</td><td>ja, an alle Empfänger:innen</td></tr>
...
<section id="b3">
  ...
  <div class="geraet-reihe">
    ...
    <figure class="geraet">
      <img src="bilder/app-03-empfaenger.webp" alt="Ansicht für Empfänger:innen mit Alarmmeldung, Quittierung und den Schritten für Empfänger:innen">
  ...
  <ol class="schritte">
    ...
    <li>
      ...
      Schritte für Empfänger:innen &ndash; ohne Notruf und ohne erneute Auslösung, beides ist
      ...
      &ndash; nicht die Schritte der Ersthelfenden oder des Hausdiensts. Die lassen sich
  ...
  <p>
    ...
    Empfänger:innen, etwa zur Rückkehr.
  </p>
...
<section id="b5">
  ...
  <p>
    ...
    in der App: Sie wählen Empfänger:innen, Kanäle und Eskalation frei. Von den Kanälen ist
  ...
  <div class="hinweis">
    ...
    <p>
      ...
      erscheint als «weitere Meldung» im Journal und bei allen Empfänger:innen, ein neu
...
<section id="b6">
  ...
  <p>
    ...
    Empfänger:innen als Mitteilung und steht in ihrer Handlungsanweisung zuoberst &ndash;
...
<section id="b7">
  ...
  <p>
    ...
    Alarm ab und versendet die Entwarnung an alle Empfänger:innen. Diese Berechtigung haben
    nur Krisenstab und Administration &ndash; Mitarbeitende können einen Alarm nicht
    beenden.
  </p>
  <p>
    <span class="ui">Beenden</span> fragt nach einem Hinweis für die Empfänger:innen, etwa
...
<section id="b9">
  ...
  <div class="hinweis">
    ...
    <p>
      ...
      Alarmserver ab und meldet «Diese Aktion ist der Administration vorbehalten».
...
<section id="b10">
  ...
  <h3>Den Ereignisbericht sichern</h3>
  <p>
    In der <span class="ui">Alarmzentrale</span> trägt jeder beendete Alarm den
    Knopf <span class="ui">Bericht</span>. Er legt den ganzen Vorgang als eine
    einzelne Datei ab: Was ausgelöst wurde, von wem, über welchen Weg, wer
    aufgeboten wurde, wer zugesagt, abgesagt oder nicht geantwortet hat, alle
    Lagemeldungen mit Zeitstempel und die Entwarnung.
  </p>
  <p>
    Die Datei öffnet in jedem Browser und braucht nichts nachzuladen &ndash; sie
    lässt sich ablegen, per Mail weitergeben und in fünf Jahren noch öffnen,
    auch wenn es dieses System dann nicht mehr gibt. Mit <span class="ui">Drucken</span>
    wird daraus ein PDF, wie bei diesem Handbuch.
  </p>
  <div class="hinweis hinweis--warnung">
    <p class="marke-klein">Der Bericht ist nicht vollständig &ndash; mit Absicht</p>
    <p>
      Er enthält nur, was das System aufgezeichnet hat. Telefonate, Entscheide
      vor Ort und Einsätze von Blaulichtorganisationen stehen nicht darin. Der
      Bericht sagt das selbst und führt am Ende auf, was von Hand zu ergänzen
      ist: Lagebeurteilung, Beteiligte ausserhalb der App, Nachbesprechung und
      abgeleitete Massnahmen. Ein Bericht, der diese Lücken glättet, wäre für
      eine Aufsichtsbehörde wertlos.
    </p>
  </div>
  <p>
