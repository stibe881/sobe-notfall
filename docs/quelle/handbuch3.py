...
<section id="c1">
  ...
  <ul>
    ...
    <li><b>Jede angemeldete Person darf alarmieren.</b> Sie brauchen keine Erlaubnis und müssen niemanden fragen. <span class="ui">SOS</span> steht auf der Startseite, <span class="ui">Ereignis wählen</span> oben rechts auf jeder Seite der App.</li>
...
<section id="c3">
  ...
  <p>
    ...
    egal wo Sie gerade sind. Auf der Startseite steht zuoberst die interne
    Notfallnummer <b>+41 41 767 49 48</b>, die per Antippen anruft; darunter
    laufende Alarme, Entwarnungen der letzten Stunden, Ihr Standort, der
    SOS-Knopf und die Kacheln der häufigen Ereignisse.
  </p>

  <h3>Zwei Wege in einen Alarm</h3>
  <p>
    Der Unterschied ist einfach:
  </p>
  <div class="tabelle-huelle">
    <table>
      <caption>SOS oder Ereignis wählen</caption>
      <thead><tr><th>Weg</th><th>Wann</th><th>Was dann geschieht</th></tr></thead>
      <tbody>
        <tr>
          <td><b>SOS</b> (grosser roter Knopf)</td>
          <td>Es braucht schnell Hilfe und der Grund muss nicht feststehen.</td>
          <td>Ruft Schulsanität und Hausdienst an Ihren Standort. Was los ist,
              melden Sie danach nach.</td>
        </tr>
        <tr>
          <td><b>Ereignis wählen</b> (Kacheln oder der umrissene Knopf oben rechts)</td>
          <td>Sie wissen, was los ist.</td>
          <td>Führt Sie durch den Ablauf dieses Szenarios &ndash; Notruf zuerst,
              dann die interne Alarmierung.</td>
        </tr>
      </tbody>
    </table>
  </div>
  <div class="hinweis">
    <p class="marke-klein">Warum nur noch ein roter Knopf</p>
    <p>
      Bis September 2026 waren beide Wege gefüllt rot und sahen gleich dringlich
      aus. Unter Druck kostete die Frage <i>«welcher von beiden?»</i> Sekunden.
      Jetzt gehört die rote Fläche dem SOS; der Weg zur Ereigniswahl ist nur
      noch umrissen.
    </p>
  </div>
  ...
  <h3>Ihr Standort</h3>
  <p>
    Über dem SOS-Knopf steht, wo die App Sie gerade führt. Das ist keine
    Nebensache: <b>Der Standort entscheidet, wer bei einem Alarm aufgeboten
    wird.</b> Darunter steht, woher die Angabe stammt &ndash; aus der Ortung im
    Gebäude, aus der Standorterkennung oder aus Ihrem Profil.
  </p>
  <p>
    Stimmt sie nicht, tippen Sie die Zeile an und wählen den richtigen Standort.
    Die Korrektur gilt eine halbe Stunde; danach übernimmt die Ortung wieder,
    damit Sie nicht dauerhaft an einem Ort geführt werden, den Sie längst
    verlassen haben.
  </p>

  <h3>Die Kacheln unter dem SOS-Knopf</h3>
  <p>
    Vier Ereignisse stehen dort zum direkten Antippen. Welche, entscheidet die
    App selbst: Was in Ihrem Haus tatsächlich ausgelöst wurde, steht vorn.
    Solange es keine Alarme gab, entscheidet die Priorität. Es gibt dafür nichts
    einzustellen, und die Reihenfolge verschiebt sich mit der Zeit von allein.
  </p>
  ...
  <div class="tabelle-huelle">
    <table>
      ...
      <tbody>
        <tr><td><b>Start</b></td><td>Interne Notfallnummer, laufende Alarme, Entwarnungen, Standort, SOS-Knopf und häufige Ereignisse</td></tr>
...
<section id="c8">
  ...
  <ol class="schritte">
    ...
    <li>
      ...
      Kolleginnen oder Kollegen dazu, unabhängig von Gruppe und Standort &ndash; das
      Suchfeld darüber findet sie nach Namen. Die App zeigt, wie viele Personen das
      ergibt.
    </li>
...
<section id="c10">
  ...
  <p>
    Sind Sie an einem anderen Standort und hat die App Ihre Ortungsfreigabe, steht dort
    dieser Standort mit dem Vermerk <span class="ui">vor Ort</span> und darunter Ihr
    Profilstandort. Oben in der App gilt dasselbe: Angezeigt wird, wo Sie gerade sind.
    Ein <span class="ui">SOS</span> und eine Alleinarbeit gelten dann für diesen
    Standort &ndash; es kommt, wer in Ihrer Nähe ist. Ohne Ortung bleibt es überall
    beim Standort aus Ihrem Profil.
  </p>
  <p>
...
<section id="c11">
  ...
  <p>
    Prüfen Sie unten auf der Anmeldemaske, mit welchem Alarmserver die App
    verbunden ist. Steht dort eine andere Adresse, gibt es Ihr Konto dort nicht.
    Hilft das nicht, meldet sich die Administration mit einem neuen Startpasswort.
  </p>
