/**
 * Grundkonfiguration des Alarmservers.
 *
 * Übernommen aus der Web-App (src/data/seed.ts): Szenarien, Standorte, Gruppen,
 * Alarmplan-Vorlagen und Notrufnummern. Beispiel-Benutzer sind bewusst nicht
 * enthalten – der Server ist der Live-Betrieb und startet mit genau einem
 * Administratorkonto (siehe seedDatabase in setup.ts).
 */

import type { Scenario, Group, Location, AlarmPlan, AlarmButton, EmergencyContact, IntegrationSettings } from './types.js'
...
export const SEED_SCENARIOS: Scenario[] = [
  {
    ...
    responseSteps: [
      ...
      { text: 'Evakuationshelfende: zugeteilte Etage abgehen, Räume kontrollieren, Personen mit Evakuationsplan zum Sammelplatz begleiten, danach der Evakuationsleitung Vollzug melden.', groupIds: ['gr-evak'] },
      { text: 'Am Sammelplatz zählen und der Evakuationsleitung melden – auch wenn alle da sind.' },
      { text: 'Ersthelfende: mit Notfallrucksack zum Sammelplatz; Verletzte und Rauchgaseinwirkung versorgen, Rettungsdienst nachfordern.', groupIds: ['gr-ersthelfer'] },
  ...
  },
  {
    ...
    instructions: [
      ...
      'Besucher:innen, Therapiegäste, Praktikant:innen und Handwerker:innen mitnehmen – sie kennen die Wege nicht.',
    ...
    responseSteps: [
      ...
      { text: 'Evakuationshelfende: zugeteilte Etage abgehen, Räume kontrollieren, Personen mit Evakuationsplan begleiten, danach Vollzug melden.', groupIds: ['gr-evak'] },
      { text: 'Besucher:innen, Therapiegäste und Handwerker:innen mitnehmen – sie kennen die Wege nicht.' },
  ...
  {
    id: 'sc-sos', icon: 'siren', title: 'SOS – Hilferuf', category: 'Sicherheit', priority: 'hoch', silentDefault: false,
    defaultChannels: ['push', 'sms', 'voice'], responsibleGroupIds: ['gr-ersthelfer', 'gr-sicherheit'],
    contactIds: ['ec-144', 'ec-117', 'ec-118'],
    callGuidance: [
      'Der SOS-Knopf sagt nur: Jemand braucht sofort Hilfe. Was passiert ist, steht nicht fest – deshalb richtet sich der Notruf nach dem, was vor Ort angetroffen wird, nicht nach der Meldung.',
      'Sanitätsnotruf 144 bei gestörtem Bewusstsein oder gestörter Atmung, starker Blutung, Sturz aus Höhe, Verdacht auf Vergiftung.',
      'Polizei 117 bei Bedrohung, Gewalt, Waffen oder wenn eine Lage zu entgleiten droht.',
      'Feuerwehr 118 bei Feuer, Rauch, Austritt von Gas oder Chemikalien, eingeklemmten Personen.',
      'Im Zweifel anrufen. Unsicherheit ist ein Grund zu rufen, kein Grund zu warten.',
      'Melden: Wo genau (Standort, Gebäude, Raum, Zufahrt), was ist passiert, wie viele Personen betroffen, Rückrufnummer.',
    ],
    instructions: [
      'Eigenschutz zuerst: Nur helfen, solange Sie sich selbst nicht gefährden.',
      'Sagen Sie nach, worum es geht – im laufenden Alarm über «Weitere Meldung». Jede Angabe spart den Helfenden Zeit und entscheidet, wer zusätzlich gebraucht wird.',
      'Bei der Person bleiben, wenn es die Lage zulässt; sonst aus dem Gefahrenbereich zurückziehen und von dort melden.',
      'Kinder und Unbeteiligte aus dem Bereich führen, Zugänge freihalten, keine Zuschauer, keine Fotos.',
      'Braucht es einen Notruf, rufen Sie ihn selbst – der App-Alarm ersetzt keinen Notruf.',
    ],
    responseSteps: [
      { text: 'Kein Notruf auf Verdacht: Was passiert ist, steht noch nicht fest. Erst hingehen, dann entscheiden – ausser die Meldung sagt bereits, worum es geht.' },
      { text: '«Ich komme» quittieren und direkt zum gemeldeten Standort. Die Art des Notfalls ist offen – rechnen Sie mit allem.' },
      { text: 'Notfallrucksack und Defibrillator mitnehmen, wenn der Weg daran vorbeiführt.', groupIds: ['gr-ersthelfer'] },
      { text: 'Vor Ort die Lage beurteilen und laut benennen, wer führt. Von der auslösenden Person erfragen: Was ist passiert, seit wann, was wurde bereits gemacht.' },
      { text: 'Passt ein anderes Szenario zur Lage, dort weiterarbeiten: Szenario in der App öffnen und dessen Schritte befolgen. Einen zweiten Alarm braucht es nur, wenn zusätzliche Gruppen dazukommen müssen.' },
      { text: 'Hausdienst: Zufahrt freihalten, Einsatzkräfte einweisen, Aufzug bereithalten, bei Bedarf Räume aufschliessen.', groupIds: ['gr-sicherheit'] },
      { text: 'Wer nicht in der Nähe ist: nichts unternehmen, erreichbar bleiben und den Bereich meiden.' },
    ],
    allClearSteps: [
      'Die Lage ist geklärt oder an die richtige Stelle übergeben – wer geholfen hat, meldet sich bei der Person zurück, die ausgelöst hat.',
      'Wurde Material gebraucht (Notfallrucksack, Defibrillator), ergänzen und Einsatzbereitschaft prüfen.',
      'Gruppe oder Klasse beruhigen und den Tagesablauf wieder aufnehmen.',
      'Ereignisprotokoll noch heute ausfüllen: Zeitpunkt, was angetroffen wurde, welche Massnahmen liefen, welche Dienste beigezogen wurden.',
    ],
    followUp: [
      'Nachbesprechen, ob der SOS-Knopf das richtige Mittel war und ob die richtigen Leute kamen – daraus entsteht die Anpassung von Gruppen und Alarmplänen.',
      'War es rückblickend ein bestimmtes Szenario, dessen Ablauf prüfen: Hat er gepasst, fehlte etwas?',
      'Bei belastenden Ereignissen Care-Angebot vermitteln – auch für die Person, die ausgelöst hat.',
      'Fehlauslösungen ohne Vorwurf besprechen. Wer aus Angst vor Tadel zögert, löst im Ernstfall zu spät aus.',
    ],
    checklist: [
      'SOS-Alarm ausgelöst',
      'Nachgemeldet, worum es geht',
      'Helfende vor Ort, Führung benannt',
      'Notruf abgesetzt, sofern nötig',
      'Einsatzkräfte eingewiesen',
      'Passendes Szenario übernommen, sofern zutreffend',
      'Entwarnung gegeben',
    ...
    legalBasis: [
      ...
      'DSG Art. 5: Angaben zu Gesundheit und Vorfällen sind besonders schützenswert – Weitergabe nur an Beteiligte mit Notwendigkeit.',
    ],
  },
  {
    ...
    allClearSteps: [
      'Die betroffene Person ist versorgt oder übergeben – Ersthelfende räumen auf und ergänzen den Notfallrucksack.',
  ...
  },
  {
    ...
    responseSteps: [
      ...
      { text: 'Ersthelfende: in Bereitschaft bleiben, nicht in den Raum – erst auf Anforderung des Deeskalationsteams.', groupIds: ['gr-ersthelfer'] },
  ...
  },
  {
    ...
    allClearSteps: [
      ...
      'Zutritts- und Besuchsregelung mit dem Hausdienst überprüfen.',
    ],
    followUp: [
  ...
  },
  {
    ...
    responseSteps: [
      ...
      { text: 'Evakuationshelfende: Gebäude systematisch nach Suchplan absuchen – Keller, Technikräume, Verstecke – und jeden geprüften Raum melden.', groupIds: ['gr-evak'] },
  ...
  },
  {
    ...
    responseSteps: [
      ...
      { text: 'Ersthelfende: nicht zum Ereignisort – Versorgung erst nach Freigabe durch die Polizei, Notfallrucksack im Sammelraum bereitstellen.', groupIds: ['gr-ersthelfer'] },
  ...
  },
  {
    ...
    instructions: [
      ...
      'Kindesschutzgruppe/Schulleitung still und vertraulich informieren – nicht im Lehrpersonenzimmer besprechen.',
  ...
  },
  {
    ...
    instructions: [
      ...
      'Schülertransporte prüfen: Abfahrten verschieben, Fahrdienst und Eltern informieren.',
    ],
    followUp: [
...
export const SEED_GROUPS: Group[] = [
  ...
  { id: 'gr-ersthelfer', name: 'Schulsanität / Ersthelfende', description: 'Ausgebildete Ersthelfende mit BLS-AED und Medikamentenschulung', isCrisisTeam: true },
  { id: 'gr-evak', name: 'Evakuationshelfende', description: 'Gebäude- und Etagenverantwortliche, Umsetzung individueller Evakuationspläne', isCrisisTeam: true },
